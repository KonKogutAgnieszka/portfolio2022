const data = {
  pl: {
    // intro section //
    introduction__title: "Cześć, jestem <strong>Agnieszka Koń-Kogut</strong>",
    introduction__subtitle: "jestem front-end developerką",
    // tech section //
    technologies__title: "technologie z których korzystam",
    technologies__mywork: "moje prace",
    // about section //
    about__title: "Kim jestem?",
    about__subtitle: "front-end samouk ;)",
    about__content:
    ...
    portfolio__4__about: "strona artysty freelancera",
  },
  en: {
    // intro section //
    introduction__title: "Hi! I'm <strong>Agnieszka Koń-Kogut</strong>",
    introduction__subtitle: "I'm front-end developer",
    // tech section //
    technologies__title: "toolbox",
    technologies__mywork: "my work",
    // about section //
    about__title: "Who I am",
    about__subtitle: "self-taught front-end;)",
    about__content:
    ...
    portfolio__4__about: "freelancer artist website",
  },
};
